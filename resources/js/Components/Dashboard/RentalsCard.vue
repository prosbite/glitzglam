...
const displayTitle = computed(() => {
    ...
    if (isToday(date)) return "Today's Transactions";
    if (isThisYear(date)) return `${format(date, "MMM d")} Transactions`;
    return `${format(date, "MMM d, yyyy")} Transactions`;
});
            ...
            <table class="w-full text-left min-w-[800px]">
                <thead class="bg-gray-50/50 border-b border-gray-100">
                    ...
                    >
                        ...
                        <th class="px-8 py-4 text-right">Agenda</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100">
                    ...
                    >
                        ...
                        <td class="px-8 py-5 text-right">
                            <span
                                class="px-3 py-1.5 text-[10px] font-bold uppercase rounded-lg"
                                :class="[
