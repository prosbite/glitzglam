...
const displayTitle = computed(() => {
    ...
    if (isToday(date)) return "Today's - For Returns";
    if (isThisYear(date)) return `${format(date, "MMM d")} - For Returns`;
    return `${format(date, "MMM d, yyyy")} - For Returns`;
});
            ...
            <table class="w-full text-left">
                <thead class="bg-gray-50/50 border-b border-gray-100">
                    ...
                    >
                        ...
                        <th class="px-6 py-4">Security Deposit</th>
                                ...
                                <template #icon>
                                    ...
                                    >
                                        <path
                                            stroke-linecap="round"
                                            stroke-linejoin="round"
                                            d="M12 4.5v11.25m0 0l-4.5-4.5m4.5 4.5l4.5-4.5"
                                        />
                                        <path
                                            stroke-linecap="round"
                                            stroke-linejoin="round"
                                            d="M21 15v3.375A2.625 2.625 0 0 1 18.375 21H5.625A2.625 2.625 0 0 1 3 18.375V15"
                                        />
                                    </svg>
                                </template>
                                Receive
        ...
        <ShinyModal :show="showModal" @close="showModal = false" size="sm">
            <template #header>
                <h3 class="text-lg font-semibold text-gray-900">
                    Receive Return Rental
                </h3>
            </template>
            <template #default>
                <p>
                    Did you hand over the security deposit to the customer? If
                    so then click "Receive" to mark the rental as received.
                </p>
            </template>
            <template #footer>
                <button
